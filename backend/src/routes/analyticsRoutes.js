...
router.get(
  ...
  authenticateToken,
  analyticsController.getPanelsByDashboard
);
...
router.post(
  ...
  authenticateToken,
  requireRole(["editor", "admin"]),
  analyticsController.createPanel
);
...
router.put(
  ...
  authenticateToken,
  requireRole(["editor", "admin"]),
  analyticsController.updatePanel
);
...
router.delete(
  ...
  authenticateToken,
  requireRole(["editor", "admin"]),
  analyticsController.deletePanel
);

// ----- Query (Prometheus Preview) -----
router.post(
  "/query",
  authenticateToken,
  analyticsController.runQuery
);
